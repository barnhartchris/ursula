  ...
  var Toast = function (text, iconhtml, options) {
    ...
    this.show = function (show) {
      if (show) {
        ...
        // Add content
        $box.attr('style','font-size:25px');
        if (text.length > 60) $box.attr('style','font-size:22px');
        if (text.length > 90) $box.attr('style','font-size:20px');
        if (text.length > 120) $box.attr('style','font-size:18px');
        if (text.length > 150) $box.attr('style','font-size:16px');
